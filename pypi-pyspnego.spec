...
%prep
%setup -q -n pyspnego-0.5.0
cd %{_builddir}/pyspnego-0.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645464957
...
cp %{_builddir}/pyspnego-0.5.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pyspnego/2b1b1a0652626080334be38bf79eba5da489acee

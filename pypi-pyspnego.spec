...
Source0  : https://files.pythonhosted.org/packages/97/b7/2ca5b546fc91d6c41e1796e49d0615fe7dfb4845d088da8a938934b3d63c/pyspnego-0.8.0.tar.gz
...
%prep
%setup -q -n pyspnego-0.8.0
cd %{_builddir}/pyspnego-0.8.0
pushd ..
cp -a pyspnego-0.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676655203

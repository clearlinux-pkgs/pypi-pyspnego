...
Version  : 0.5.4
Release  : 14
URL      : https://files.pythonhosted.org/packages/5b/cb/79b852d3c78d5b6d156d4b31dd4024dcfb62a3a3758fc35b53df2675fb62/pyspnego-0.5.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/5b/cb/79b852d3c78d5b6d156d4b31dd4024dcfb62a3a3758fc35b53df2675fb62/pyspnego-0.5.4.tar.gz
...
%prep
%setup -q -n pyspnego-0.5.4
cd %{_builddir}/pyspnego-0.5.4
pushd ..
cp -a pyspnego-0.5.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660231070

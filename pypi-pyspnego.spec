...
Source0  : https://files.pythonhosted.org/packages/6b/f8/53f1fc851dab776a183ffc9f29ebde244fbb467f5237f3ea809519fc4b2e/pyspnego-0.11.2.tar.gz
...
%prep
%setup -q -n pyspnego-0.11.2
cd %{_builddir}/pyspnego-0.11.2
pushd ..
cp -a pyspnego-0.11.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731433389

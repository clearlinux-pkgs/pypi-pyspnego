...
Source0  : https://files.pythonhosted.org/packages/f0/6b/823c4363e2c24d8b57c3ab24680b62186f567fc40ec007723f6793257459/pyspnego-0.6.2.tar.gz
...
%prep
%setup -q -n pyspnego-0.6.2
cd %{_builddir}/pyspnego-0.6.2
pushd ..
cp -a pyspnego-0.6.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666838928

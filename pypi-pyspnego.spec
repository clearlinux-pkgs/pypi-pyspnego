...
Source0  : https://files.pythonhosted.org/packages/48/2b/805b8a94733ca3c7a68aafeee4076d59863b717d27674e267eafb4aeca85/pyspnego-0.6.1.tar.gz
...
%prep
%setup -q -n pyspnego-0.6.1
cd %{_builddir}/pyspnego-0.6.1
pushd ..
cp -a pyspnego-0.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666742650

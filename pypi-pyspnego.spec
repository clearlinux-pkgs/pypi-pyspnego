...
Source0  : https://files.pythonhosted.org/packages/98/f8/fe0b92c762ad5e317092a9574e7d73d240878982364483328e76e573bb37/pyspnego-0.5.1.tar.gz
...
%prep
%setup -q -n pyspnego-0.5.1
cd %{_builddir}/pyspnego-0.5.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647894285
...
cp %{_builddir}/pyspnego-0.5.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pyspnego/2b1b1a0652626080334be38bf79eba5da489acee

...
Source0  : https://files.pythonhosted.org/packages/2b/01/3b26738ad7c675d558d71598bab5738750bd17877d3205cef7a8a680e7fc/pyspnego-0.11.0.tar.gz
...
%prep
%setup -q -n pyspnego-0.11.0
cd %{_builddir}/pyspnego-0.11.0
pushd ..
cp -a pyspnego-0.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718297415

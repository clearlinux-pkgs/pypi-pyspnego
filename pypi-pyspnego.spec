...
Source0  : https://files.pythonhosted.org/packages/b6/d6/e746aae9fc4d8bbb5a0e2505636de6b5a92e94a6e4c1cd1a032f4272e491/pyspnego-0.5.3.tar.gz
...
%prep
%setup -q -n pyspnego-0.5.3
cd %{_builddir}/pyspnego-0.5.3
pushd ..
cp -a pyspnego-0.5.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657555327
...
cp %{_builddir}/pyspnego-0.5.3/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pyspnego/2b1b1a0652626080334be38bf79eba5da489acee
